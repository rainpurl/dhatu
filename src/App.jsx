...
const TOPICS = [
  ...
  { id:"colors", title:"Colors", icon:"palette", words:[
    ...
    { gu:"સફેદ", r:"safed", en:"white", alt:[{gu:"ધોળો", r:"dhoḷo"}] },
    { gu:"નારંગી", r:"naarangi", en:"orange" },
    { gu:"ગુલાબી", r:"gulaabi", en:"pink" },
    { gu:"જાંબલી", r:"jaambli", en:"purple" },
    { gu:"કથ્થાઈ", r:"kaththaai", en:"brown", alt:[{gu:"બદામી", r:"badaami"}] },
  ]},
  { id:"animals", title:"Animals", icon:"paw", words:[
    ...
    { gu:"પક્ષી", r:"pakshi", en:"bird", alt:[{gu:"પંખી", r:"pankhi"}] },
...
function CourseApp({ user }) {
  ...
  if (screen === "vocabPractice" && selTopic) {
    ...
    // Speech recognition loops on a lone word, so practice it inside a full
    // sentence. Prefer the hand-tailored per-word sentence (VOCAB_SENT: natural,
    // correct, with an accurate English translation); fall back to the older
    // template, then to the bare word. Function-word topics (questions,
    // connectors, greetings) skip speech. Already-phrase entries are spoken as-is.
    const single = _isSingleWord(word.gu);
    const skipSpeech = single && CARRIER_SKIP_TOPICS.has(topic.id);
    const sent = !skipSpeech ? VOCAB_SENT[word.gu] : null;
    const carrier = !sent && single && !skipSpeech ? _carrierFor(topic.id, word) : null;
    const sayGu = sent ? sent.s : carrier ? carrier.gu : word.gu;
    const sayR = sent ? sent.r : carrier ? carrier.r : word.r;
    const sayEn = sent ? sent.e : carrier ? carrier.en : word.en;
    return (
      <div className="dhatu">
        <style>{CSS}</style>
        <div className="scr plain">
          ...
          <div className="playrow"><button className="playbtn" onClick={() => speakGu(sayGu, _voiceForId(topic.id))}><Ic.play /></button></div>
...
TOPICS.push(
  ...
  { id:"body", title:"The body", icon:"profile", words:[
    ...
    { gu:"મોઢું", r:"moḍhuṁ", en:"mouth / face", alt:[{gu:"મોં", r:"moṁ"}] },
  ...
  { id:"places", title:"Places around town", icon:"temple", words:[
    ...
    { gu:"ગામ", r:"gaam", en:"village", alt:[{gu:"ગામડું", r:"gaamḍuṁ"}] },
    { gu:"રસ્તો", r:"rasto", en:"road" },
    { gu:"મંદિર", r:"mandir", en:"temple" },
    { gu:"દવાખાનું", r:"davaakhaanuṁ", en:"hospital", alt:[{gu:"હોસ્પિટલ", r:"hospiṭal"}] },
...
TOPICS.push(
  { id:"nature", title:"Nature and land", icon:"star", words:[
    ...
    { gu:"સૂરજ", r:"sooraj", en:"sun", alt:[{gu:"સૂર્ય", r:"soorya"}] },
    { gu:"ચંદ્ર", r:"chandra", en:"moon", alt:[{gu:"ચાંદ", r:"chaand"}] },
...
// Natural example sentence per single-word vocab item (gu sentence, roman, en),
// generated per word so phrases and translations are correct in context. Keyed
// by the Gujarati word. Replaces the old mechanical carrier templates.
const VOCAB_SENT = {
  "અંદર": {s:"પુસ્તક બેગની અંદર છે", r:"pustak begni andar chhe", e:"The book is inside the bag"},
  "અકસ્માત": {s:"રસ્તા પર અકસ્માત થયો", r:"rastaa par akasmaat thayo", e:"An accident happened on the road"},
  "અગરબત્તી": {s:"મમ્મીએ અગરબત્તી સળગાવી", r:"mammie agarbatti saḷgaavi", e:"Mom lit an incense stick"},
  "અગિયાર": {s:"મારી પાસે અગિયાર રૂપિયા છે", r:"maari paase agiyaar rupiyaa chhe", e:"I have eleven rupees"},
  "અજરખ": {s:"આ અજરખ કાપડ બહુ સુંદર છે", r:"aa ajrakh kaapaḍ bahu sundar chhe", e:"This Ajrakh cloth is very beautiful"},
  "અઠવાડિયું": {s:"એક અઠવાડિયામાં સાત દિવસ હોય છે", r:"ek aṭhvaaḍiyaamaaṁ saat divas hoy chhe", e:"There are seven days in a week"},
  "અઢાર": {s:"તે અઢાર વર્ષની થઈ", r:"te aḍhaar varshni thai", e:"She turned eighteen"},
  "અનાજ": {s:"અમે અનાજ કોઠારમાં રાખીએ છીએ", r:"ame anaaj koṭhaarmaa raakhie chhie", e:"We keep the grain in the storeroom"},
  "અરજી": {s:"મેં રજા માટે અરજી કરી", r:"meṁ rajaa maaṭe arji kari", e:"I made an application for leave"},
  "આંખ": {s:"તેની આંખ સુંદર છે", r:"teni aankh sundar chhe", e:"Her eye is beautiful"},
  "આંગળી": {s:"મારી આંગળી કપાઈ ગઈ", r:"maari aangḷi kapaai gai", e:"My finger got cut"},
  "આકાશ": {s:"આકાશ ભૂરું છે", r:"aakaash bhooruṁ chhe", e:"The sky is blue"},
  "આગ": {s:"ઘરમાં આગ લાગી છે", r:"gharmaa aag laagi chhe", e:"There is a fire in the house"},
  "આગળ": {s:"ઘરની આગળ એક ઝાડ છે", r:"gharni aagaḷ ek jhaaḍ chhe", e:"There is a tree in front of the house"},
  "આજે": {s:"આજે હવામાન બહુ સરસ છે", r:"aaje havaamaan bahu saras chhe", e:"Today the weather is very nice"},
  "આઠ": {s:"મારી પાસે આઠ રૂપિયા છે", r:"maari paase aaṭh rupiyaa chhe", e:"I have eight rupees"},
  "આનંદ": {s:"બાળકો આનંદથી રમે છે", r:"baaḷko aanandthi rame chhe", e:"The children play joyfully"},
  "આપવું": {s:"મને પાણી આપો", r:"mane paaṇi aapo", e:"Give me water"},
  "આરતી": {s:"સાંજે મંદિરમાં આરતી થાય છે", r:"saanje mandirmaa aarti thaay chhe", e:"In the evening there is aarti at the temple"},
  "આરામ": {s:"તને આરામની જરૂર છે", r:"tane aaraamni jaroor chhe", e:"You need rest"},
  "આળસુ": {s:"તે છોકરો બહુ આળસુ છે", r:"te chhokro bahu aaḷasu chhe", e:"That boy is very lazy"},
  "આવતીકાલે": {s:"આવતીકાલે અમે શાળાએ જઈશું", r:"aavtikaale ame shaaḷaae jaishuṁ", e:"Tomorrow we will go to school"},
  "આવવું": {s:"તમારે કાલે ઘરે આવવું", r:"tamaare kaale ghare aavvuṁ", e:"You should come home tomorrow"},
  "આશીર્વાદ": {s:"વડીલોના આશીર્વાદ લો", r:"vaḍilonaa aasheervaad lo", e:"Take the blessings of the elders"},
  "આશ્ચર્ય": {s:"મને આ સમાચારથી આશ્ચર્ય થયું", r:"mane aa samaachaarthi aashcharya thayuṁ", e:"I was surprised by this news"},
  "ઇન્ટરનેટ": {s:"ઘરમાં ઇન્ટરનેટ ચાલુ છે", r:"gharmaaṁ inṭarneṭ chaalu chhe", e:"The internet is on at home"},
  "ઉકાળવું": {s:"પાણી ઉકાળવું છે", r:"paaṇi ukaaḷvuṁ chhe", e:"The water needs to be boiled"},
  "ઉડાન": {s:"અમારી ઉડાન સવારે છે", r:"amaaree uḍaan savaare chhe", e:"Our flight is in the morning"},
  "ઉત્તરાયણ": {s:"ઉત્તરાયણમાં અમે પતંગ ઉડાડીએ છીએ", r:"uttaraayanmaa ame pataṅg uḍaaḍie chhie", e:"On Uttarayan we fly kites"},
  "ઉદાસ": {s:"તે આજે બહુ ઉદાસ છે", r:"te aaje bahu udaas chhe", e:"He is very sad today"},
  "ઉધરસ": {s:"મને બહુ ઉધરસ આવે છે", r:"mane bahu udhras aave chhe", e:"I am coughing a lot"},
  "ઉધાર": {s:"મેં દુકાનેથી ઉધાર લીધો", r:"meṁ dukaanethi udhaar leedho", e:"I took credit from the shop"},
  "ઉનાળો": {s:"ઉનાળામાં બહુ ગરમી હોય છે", r:"unaaḷaamaaṁ bahu garmi hoy chhe", e:"It is very hot in summer"},
  "ઉપર": {s:"બિલાડી ટેબલ ઉપર બેઠી છે", r:"bilaaḍi ṭebal upar beṭhi chhe", e:"The cat is sitting on the table"},
  "ઉપવાસ": {s:"આજે મારો ઉપવાસ છે", r:"aaje maaro upvaas chhe", e:"Today I am fasting"},
  "ઊંધિયું": {s:"શિયાળામાં અમે ઊંધિયું ખાઈએ છીએ", r:"shiyaaḷaamaa ame uṅdhiyuṁ khaaie chhie", e:"In winter we eat undhiyu"},
  "ઊઠવું": {s:"હું સવારે વહેલો ઊઠું છું", r:"huṁ savaare vahelo ooṭhuṁ chhuṁ", e:"I wake up early in the morning"},
  "ઊતરવું": {s:"અમે બસમાંથી ઊતર્યા", r:"ame basmaanthee ootaryaa", e:"We got down from the bus"},
  "એંસી": {s:"મારાં દાદી એંસી વર્ષનાં છે", r:"maaraaṁ daadi eṁsi varshnaaṁ chhe", e:"My grandmother is eighty years old"},
  "એક": {s:"મારી પાસે એક કૂતરો છે", r:"maari paase ek kutro chhe", e:"I have one dog"},
  "એકલું": {s:"બાળક ઘરમાં એકલું રહે છે", r:"baaḷak gharmaaṁ ekluṁ rahe chhe", e:"The child lives alone in the house"},
  "એકવીસ": {s:"મારો ભાઈ એકવીસ વર્ષનો છે", r:"maaro bhaai ekvees varshno chhe", e:"My brother is twenty-one years old"},
  "ઓગણીસ": {s:"અહીં ઓગણીસ લોકો છે", r:"ahiṁ ogaṇees loko chhe", e:"There are nineteen people here"},
  "ઓછું": {s:"આજે ઓછું ખાવાનું બન્યું", r:"aaje ochhuṁ khaavaanuṁ banyuṁ", e:"Less food was cooked today"},
  "ઓફિસ": {s:"મારી ઓફિસ શહેરમાં છે", r:"maari ofis shaharmaa chhe", e:"My office is in the city"},
  "ઓરડો": {s:"આ ઓરડો બહુ સ્વચ્છ છે", r:"aa orḍo bahu svachchh chhe", e:"This room is very clean"},
  "ઓર્ડર": {s:"અમે ઓર્ડર આપ્યો", r:"ame orḍar aapyo", e:"We placed the order"},
  "કંઈ": {s:"તારે કંઈ ખાવું છે?", r:"taare kaṁi khaavuṁ chhe?", e:"Do you want something to eat?"},
  "કંટાળો": {s:"મને ઘરે કંટાળો આવે છે", r:"mane ghare kanṭaaḷo aave chhe", e:"I feel bored at home"},
  "કંદમૂળ": {s:"અમે કંદમૂળ ખાતા નથી", r:"ame kandmooḷ khaataa nathi", e:"We do not eat root vegetables"},
  "કચરો": {s:"કચરો ડબ્બામાં નાખો", r:"kachro ḍabbaamaa naakho", e:"Put the trash in the bin"},
  "કથ્થાઈ": {s:"મારા વાળ કથ્થાઈ છે", r:"maaraa vaaḷ kaththaai chhe", e:"My hair is brown"},
  "કન્યા": {s:"કન્યા બહુ સુંદર લાગે છે", r:"kanyaa bahu sundar laage chhe", e:"The bride looks very beautiful"},
  "કપડાં": {s:"મારાં કપડાં નવાં છે", r:"maaraan kapḍaan navaan chhe", e:"My clothes are new"},
  "કમ્પ્યુટર": {s:"હું કમ્પ્યુટર પર કામ કરું છું", r:"huṁ kampyuṭar par kaam karuṁ chhuṁ", e:"I work on the computer"},
  "કરવત": {s:"કરવતથી લાકડું કાપો", r:"karvatthi laakḍuṁ kaapo", e:"Cut the wood with the saw"},
  "કરવું": {s:"મારે કામ કરવું છે", r:"maare kaam karvuṁ chhe", e:"I have to do work"},
  "કરોડ": {s:"આ મકાન એક કરોડનું છે", r:"aa makaan ek karoḍnuṁ chhe", e:"This house costs one crore"},
  "કર્મચારી": {s:"કર્મચારી ઓફિસમાં કામ કરે છે", r:"karmachaari ofismaaṁ kaam kare chhe", e:"The employee works in the office"},
  "કલાક": {s:"હું એક કલાક વાંચું છું", r:"huṁ ek kalaak vaanchuṁ chhuṁ", e:"I read for one hour"},
  "કહેવું": {s:"મને એક વાત કહો", r:"mane ek vaat kaho", e:"Tell me something"},
  "કાકા": {s:"કાકા કાલે આવશે", r:"kaakaa kaale aavshe", e:"Uncle will come tomorrow"},
  "કાગળ": {s:"મને એક કાગળ જોઈએ છે", r:"mane ek kaagaḷ joīe chhe", e:"I need a piece of paper"},
  "કાચ": {s:"કાચનો ગ્લાસ તૂટી ગયો", r:"kaachno glaas tuṭi gayo", e:"The glass tumbler broke"},
  "કાતર": {s:"કાતરથી કાગળ કાપો", r:"kaatarthi kaagaḷ kaapo", e:"Cut the paper with scissors"},
  "કાન": {s:"તેના કાન મોટા છે", r:"tenaa kaan moṭaa chhe", e:"His ears are big"},
  "કામ": {s:"મારે આજે ઘણું કામ છે", r:"maare aaje ghaṇuṁ kaam chhe", e:"I have a lot of work today"},
  "કાળો": {s:"મારો કૂતરો કાળો છે", r:"maaro kootro kaaḷo chhe", e:"My dog is black"},
  "કિંમત": {s:"આ પુસ્તકની કિંમત ઓછી છે", r:"aa pustakni kimmat ochhi chhe", e:"The cost of this book is low"},
  "કિલો": {s:"મને એક કિલો ટમેટાં આપો", r:"mane ek kilo ṭameṭaṁ aapo", e:"Give me one kilo of tomatoes"},
  "કીડી": {s:"એક કીડી ખાંડ પર ચઢી", r:"ek keeḍi khaaṇḍ par chaḍhi", e:"An ant climbed onto the sugar"},
  "કુટુંબ": {s:"મારું કુટુંબ મોટું છે", r:"maaruṁ kuṭumb moṭuṁ chhe", e:"My family is big"},
  "કૂતરો": {s:"મારો કૂતરો બહુ વફાદાર છે", r:"maaro kootro bahu vafaadaar chhe", e:"My dog is very loyal"},
  "કૂદવું": {s:"બાળક પલંગ પર કૂદે છે", r:"baaḷak palang par koode chhe", e:"The child jumps on the bed"},
  "કૂવો": {s:"ગામમાં એક જૂનો કૂવો છે", r:"gaammaa ek joono koovo chhe", e:"There is an old well in the village"},
  "કેટલું?": {s:"આ કેરી કેટલાની છે?", r:"aa keri keṭlaani chhe?", e:"How much is this mango?"},
  "કેડિયું": {s:"મારો ભાઈ કેડિયું પહેરે છે", r:"maaro bhaai keḍiyuṁ pahere chhe", e:"My brother wears a kediyu"},
  "કેરી": {s:"કેરી બહુ મીઠી છે", r:"keri bahu meeṭhi chhe", e:"The mango is very sweet"},
  "કેળું": {s:"મને કેળું બહુ ભાવે છે", r:"mane keḷuṁ bahu bhaave chhe", e:"I really like bananas"},
  "કોઈ": {s:"બહાર કોઈ ઊભું છે", r:"bahaar koi oobhuṁ chhe", e:"Someone is standing outside"},
  "ક્રિકેટ": {s:"અમે મેદાનમાં ક્રિકેટ રમીએ છીએ", r:"ame medaanmaa krikeṭ ramie chhie", e:"We play cricket in the field"},
  "ખતરો": {s:"અહીં બહુ ખતરો છે", r:"ahiṁ bahu khataro chhe", e:"There is a lot of danger here"},
  "ખભો": {s:"મારો ખભો દુખે છે", r:"maaro khabho dukhe chhe", e:"My shoulder hurts"},
  "ખમણ": {s:"ખમણ નરમ અને સ્વાદિષ્ટ છે", r:"khaman naram ane svaadishṭ chhe", e:"Khaman is soft and tasty"},
  "ખરાબ": {s:"આજે હવામાન ખરાબ છે", r:"aaje havaamaan kharaab chhe", e:"The weather is bad today"},
  "ખરીદવું": {s:"મારે શાક ખરીદવું છે", r:"maare shaak kharidvuṁ chhe", e:"I want to buy vegetables"},
  "ખાંડ": {s:"ચામાં ખાંડ નાખો", r:"chaamaaṁ khaanḍ naakho", e:"Put sugar in the tea"},
  "ખાતું": {s:"મારું બેંકમાં ખાતું છે", r:"maaruṁ benkmaa khaatuṁ chhe", e:"I have an account at the bank"},
  "ખાવું": {s:"મને શાક ખાવું ગમે છે", r:"mane shaak khaavuṁ game chhe", e:"I like to eat vegetables"},
  "ખીલી": {s:"દીવાલમાં ખીલી ઠોકો", r:"deevaalmaa kheeli ṭhoko", e:"Hammer a nail into the wall"},
  "ખુરશી": {s:"હું ખુરશી પર બેઠો છું", r:"huṁ khurshi par beṭho chhuṁ", e:"I am sitting on the chair"},
  "ખુશ": {s:"આજે હું બહુ ખુશ છું", r:"aaje huṁ bahu khush chhuṁ", e:"Today I am very happy"},
  "ખૂણો": {s:"ખુરશી ખૂણામાં છે", r:"khurshi khooṇaamaa chhe", e:"The chair is in the corner"},
  "ખેડૂત": {s:"ખેડૂત ખેતરમાં કામ કરે છે", r:"kheḍoot khetarmaa kaam kare chhe", e:"The farmer works in the field"},
  "ખેતર": {s:"ખેડૂત ખેતરમાં કામ કરે છે", r:"kheḍoot khetarmaaṁ kaam kare chhe", e:"The farmer works in the field"},
  "ખોલવું": {s:"બારી ખોલો", r:"baari kholo", e:"Open the window"},
  "ગઈકાલે": {s:"ગઈકાલે હું બજારે ગયો હતો", r:"gaikaale huṁ bajaare gayo hato", e:"Yesterday I went to the market"},
  "ગરબા": {s:"મને ગરબા રમવા ગમે છે", r:"mane garbaa ramvaa game chhe", e:"I like to dance Garba"},
  "ગરમ": {s:"ચા બહુ ગરમ છે", r:"chaa bahu garam chhe", e:"The tea is very hot"},
  "ગરમી": {s:"આજે બહુ ગરમી છે", r:"aaje bahu garmi chhe", e:"It is very hot today"},
  "ગર્વ": {s:"મને મારા દીકરા પર ગર્વ છે", r:"mane maaraa deekraa par garv chhe", e:"I am proud of my son"},
  "ગળી": {s:"ગળીનો રંગ વાદળી છે", r:"gaḷino raṁg vaadaḷi chhe", e:"The color of indigo is blue"},
  "ગળું": {s:"મારું ગળું દુખે છે", r:"maaruṁ gaḷuṁ dukhe chhe", e:"My throat hurts"},
  "ગાંઠ": {s:"દોરી પર એક ગાંઠ છે", r:"dori par ek gaanṭh chhe", e:"There is a knot on the string"},
  "ગાજર": {s:"ગાજર નારંગી રંગનું છે", r:"gaajar naarangi rangnuṁ chhe", e:"The carrot is orange in color"},
  "ગાડી": {s:"મારી ગાડી બહાર ઊભી છે", r:"maari gaaḍi bahaar ubhi chhe", e:"My car is parked outside"},
  "ગામ": {s:"મારું ગામ બહુ સુંદર છે", r:"maaruṁ gaam bahu sundar chhe", e:"My village is very beautiful"},
  "ગાય": {s:"ગાય ઘાસ ખાય છે", r:"gaay ghaas khaay chhe", e:"The cow eats grass"},
  "ગાયક": {s:"આ ગાયક બહુ સરસ ગાય છે", r:"aa gaayak bahu saras gaay chhe", e:"This singer sings very well"},
  "ગીત": {s:"મને આ ગીત બહુ ગમે છે", r:"mane aa geet bahu game chhe", e:"I really like this song"},
  "ગુમ": {s:"મારો દીકરો મેળામાં ગુમ થયો", r:"maaro deekro meḷaamaa gum thayo", e:"My son got lost at the fair"},
  "ગુરુવાર": {s:"ગુરુવારે પપ્પા આવે છે", r:"guruvaare pappa aave chhe", e:"Dad comes on Thursday"},
  "ગુલાબી": {s:"તેની પાસે ગુલાબી બેગ છે", r:"teni paase gulaabi beg chhe", e:"She has a pink bag"},
  "ગુસ્સો": {s:"મને તારા પર ગુસ્સો આવ્યો", r:"mane taaraa par gusso aavyo", e:"I got angry at you"},
  "ગોકળગાય": {s:"ગોકળગાય ધીમે ધીમે ચાલે છે", r:"gokaḷgaay dhime dhime chaale chhe", e:"The snail walks very slowly"},
  "ઘંટ": {s:"મંદિરમાં ઘંટ વાગે છે", r:"mandirmaa ghanṭ vaage chhe", e:"The bell rings in the temple"},
  "ઘઉં": {s:"ઘઉંનો લોટ સફેદ છે", r:"ghauṁno loṭ safed chhe", e:"The wheat flour is white"},
  "ઘડિયાળ": {s:"મારી ઘડિયાળ ધીમી ચાલે છે", r:"maari ghaḍiyaaḷ dheemi chaale chhe", e:"My watch runs slow"},
  "ઘણું": {s:"આજે ઘણું કામ છે", r:"aaje ghaṇuṁ kaam chhe", e:"There is a lot of work today"},
  "ઘર": {s:"મારું ઘર બહુ મોટું છે", r:"maaruṁ ghar bahu moṭuṁ chhe", e:"My house is very big"},
  "ઘરચોળું": {s:"મારી બહેને ઘરચોળું પહેર્યું", r:"maari bahene gharcholuṁ paheryuṁ", e:"My sister wore a bridal cloth"},
  "ઘોડો": {s:"ઘોડો બહુ ઝડપથી દોડે છે", r:"ghoḍo bahu jhaḍapthi doḍe chhe", e:"The horse runs very fast"},
  "ચંદ્ર": {s:"આજે ચંદ્ર બહુ સુંદર છે", r:"aaje chandra bahu sundar chhe", e:"The moon is very beautiful today"},
  "ચંપલ": {s:"મારાં ચંપલ નવાં છે", r:"maaraan champal navaan chhe", e:"My sandals are new"},
  "ચણિયાચોળી": {s:"તે ગરબામાં ચણિયાચોળી પહેરે છે", r:"te garbaamaa chaṇiyaachoḷi pahere chhe", e:"She wears a chaniya choli at Garba"},
  "ચણિયો": {s:"તેણે લાલ ચણિયો પહેર્યો છે", r:"teṇe laal chaṇiyo pheryo chhe", e:"She is wearing a red chaniyo"},
  "ચમચી": {s:"મને એક ચમચી આપો", r:"mane ek chamchi aapo", e:"Give me a spoon"},
  "ચશ્માં": {s:"મને ચશ્માં વગર દેખાતું નથી", r:"mane chashmaan vagar dekhaatuṁ nathi", e:"I can't see without glasses"},
  "ચા": {s:"મને સવારે ચા જોઈએ છે", r:"mane savaare chaa joie chhe", e:"I need tea in the morning"},
  "ચાખવું": {s:"જરા શાક ચાખી જુઓ", r:"jaraa shaak chaakhi juo", e:"Just taste the vegetable dish"},
  "ચામડું": {s:"મારા બૂટ ચામડાના છે", r:"maaraa buṭ chaamḍaanaa chhe", e:"My shoes are made of leather"},
  "ચાર": {s:"ટેબલ પર ચાર સફરજન છે", r:"ṭebal par chaar safarjan chhe", e:"There are four apples on the table"},
  "ચાર્જર": {s:"મને ચાર્જર આપો", r:"mane chaarjar aapo", e:"Give me the charger"},
  "ચાળીસ": {s:"મારા પિતા ચાળીસ વર્ષના છે", r:"maaraa pitaa chaaḷees varshnaa chhe", e:"My father is forty years old"},
  "ચાવી": {s:"મારી ચાવી ખોવાઈ ગઈ", r:"maari chaavi khovaai gai", e:"My key got lost"},
  "ચિંતા": {s:"મને પરીક્ષાની ચિંતા છે", r:"mane pareekshaani chintaa chhe", e:"I am worried about the exam"},
  "ચૂકવવું": {s:"મારે બિલ ચૂકવવું છે", r:"maare bil chookavvuṁ chhe", e:"I have to pay the bill"},
  "ચૂલો": {s:"ચૂલો સળગાવો", r:"choolo saḷgaavo", e:"Light the stove"},
  "ચોથો": {s:"આજે ચોથો દિવસ છે", r:"aaje chotho divas chhe", e:"Today is the fourth day"},
  "ચોપડી": {s:"મારી પાસે નવી ચોપડી છે", r:"maari paase navi chopḍi chhe", e:"I have a new book"},
  "ચોમાસું": {s:"ચોમાસામાં ખૂબ વરસાદ પડે છે", r:"chomaasaamaaṁ khoob varsaad paḍe chhe", e:"It rains a lot in the monsoon"},
  "ચોર": {s:"ચોર મારું પર્સ લઈ ગયો", r:"chor maaruṁ pars lai gayo", e:"The thief took my purse"},
  "ચૌદ": {s:"વર્ગમાં ચૌદ છોકરા છે", r:"vargmaaṁ chaud chhokraa chhe", e:"There are fourteen boys in the class"},
  "છ": {s:"અહીં છ ખુરશી છે", r:"ahiṁ chha khurshi chhe", e:"There are six chairs here"},
  "છઠ્ઠો": {s:"આ મારો છઠ્ઠો પ્રશ્ન છે", r:"aa maaro chhaṭhṭho prashna chhe", e:"This is my sixth question"},
  "છત": {s:"છત પર પંખો છે", r:"chhat par paṁkho chhe", e:"There is a fan on the ceiling"},
  "છરી": {s:"છરી બહુ તીક્ષ્ણ છે", r:"chhari bahu tikshṇa chhe", e:"The knife is very sharp"},
  "છાપકામ": {s:"તે છાપકામ શીખે છે", r:"te chhaapkaam shikhe chhe", e:"He is learning block printing"},
  "છેલ્લો": {s:"આજે છેલ્લો દિવસ છે", r:"aaje chhello divas chhe", e:"Today is the last day"},
  "જંગલ": {s:"જંગલમાં ઘણાં પ્રાણી છે", r:"jangalmaaṁ ghaṇaaṁ praaṇi chhe", e:"There are many animals in the forest"},
  "જબરું": {s:"આ ગીત જબરું છે", r:"aa geet jabaruṁ chhe", e:"This song is amazing"},
  "જમણે": {s:"જમણે બજાર છે", r:"jamṇe bajaar chhe", e:"The market is on the right"},
  "જમવું": {s:"અમે સાથે જમવા બેઠા", r:"ame saathe jamvaa beṭhaa", e:"We sat down to eat together"},
  "જલદી": {s:"જલદી અહીં આવો", r:"jaldi ahiṁ aavo", e:"Come here quickly"},
  "જલસો": {s:"આજે અમને બહુ જલસો પડ્યો", r:"aaje amne bahu jalso paḍyo", e:"We had a great time today"},
  "જલેબી": {s:"મને મીઠી જલેબી ગમે છે", r:"mane miṭhi jalebi game chhe", e:"I like sweet jalebi"},
  "જવાબ": {s:"તમારો જવાબ સાચો છે", r:"tamaaro javaab saacho chhe", e:"Your answer is correct"},
  "જવું": {s:"મારે નિશાળે જવું છે", r:"maare nishaaḷe javuṁ chhe", e:"I want to go to school"},
  "જાંબલી": {s:"મને જાંબલી રંગ ગમે છે", r:"mane jaambli raṅg game chhe", e:"I like the purple color"},
  "જામફળ": {s:"મારી પાસે એક જામફળ છે", r:"maari paase ek jaamphaḷ chhe", e:"I have one guava"},
  "જીતવું": {s:"અમને રમત જીતવી છે", r:"amne ramat jeetvi chhe", e:"We want to win the game"},
  "જીભ": {s:"મારી જીભ દાઝી ગઈ", r:"maari jeebh daajhi gai", e:"My tongue got burned"},
  "જીવનસાથી": {s:"તે મારો જીવનસાથી છે", r:"te maaro jeevansaathi chhe", e:"He is my life partner"},
  ...
  "જોવું": {s:"મને ફિલ્મ જોવી ગમે છે", r:"mane film jovee game chhe", e:"I like to watch a movie"},
  ...
  "ઝાડુ": {s:"મમ્મી ઝાડુથી ઘર વાળે છે", r:"mammi jhaaḍuthi ghar vaaḷe chhe", e:"Mom sweeps the house with the broom"},
  "ઝુમખાં": {s:"તેણે નવાં ઝુમખાં પહેર્યાં", r:"teṇe navaan jhumkhaan pahernyaan", e:"She wore new earrings"},
  "ટમેટું": {s:"ટમેટું લાલ અને નાનું છે", r:"ṭameṭuṁ laal ane naanuṁ chhe", e:"The tomato is red and small"},
  "ટાઇટ": {s:"તારો ડ્રેસ ટાઇટ છે", r:"taaro ḍres ṭaaiṭ chhe", e:"Your dress is excellent"},
  "ટિકિટ": {s:"મેં ટ્રેનની ટિકિટ ખરીદી", r:"meṁ ṭrenanee ṭikiṭ khareedee", e:"I bought a train ticket"},
  "ટીપ": {s:"વેઇટરને ટીપ આપો", r:"veiṭarne ṭip aapo", e:"Give a tip to the waiter"},
  "ટીમ": {s:"અમારી ટીમ બહુ સારી છે", r:"amaari ṭeem bahu saari chhe", e:"Our team is very good"},
  "ટીવી": {s:"અમે ટીવી જોઈએ છીએ", r:"ame ṭeevee joīe chhīe", e:"We are watching television"},
  "ટોપા": {s:"એ ટોપા, આમ ના કર", r:"e ṭopaa, aam naa kar", e:"Hey fool, don't do this"},
  "ટોપી": {s:"છોકરો ટોપી પહેરે છે", r:"chhokaro ṭopi pahere chhe", e:"The boy wears a cap"},
  "ટ્રેન": {s:"ટ્રેન સ્ટેશન પર ઊભી છે", r:"ṭren sṭeshan par ubhi chhe", e:"The train is standing at the station"},
  "ઠંડી": {s:"આજે બહુ ઠંડી છે", r:"aaje bahu ṭhanḍi chhe", e:"It is very cold today"},
  "ઠંડું": {s:"પાણી ઠંડું છે", r:"paaṇi ṭhanḍuṁ chhe", e:"The water is cold"},
  "ડર": {s:"મને અંધારાનો ડર લાગે છે", r:"mane andhaaraano ḍar laage chhe", e:"I am afraid of the dark"},
  "ડાબે": {s:"ડાબે વળો અને આગળ જાઓ", r:"ḍaabe vaḷo ane aagaḷ jaao", e:"Turn left and go ahead"},
  "ડુંગળી": {s:"શાકમાં ડુંગળી નાખો", r:"shaakmaa ḍungaḷi naakho", e:"Put onion in the vegetable dish"},
  "ડૂબવું": {s:"હોડી પાણીમાં ડૂબી ગઈ", r:"hoḍee paaṇeemaan ḍoobee gaee", e:"The boat sank in the water"},
  "ડૉક્ટર": {s:"ડૉક્ટર દવાખાનામાં છે", r:"ḍokṭar davaakhaanaamaa chhe", e:"The doctor is at the clinic"},
  "ડોલ": {s:"ડોલમાં પાણી ભરો", r:"ḍolmaa paaṇi bharo", e:"Fill water in the bucket"},
  "ડ્રાઇવર": {s:"ડ્રાઇવર બસ ચલાવે છે", r:"ḍraaivar bas chalaave chhe", e:"The driver drives the bus"},
  "ઢોલ": {s:"ઢોલ બહુ મોટેથી વાગે છે", r:"ḍhol bahu moṭethi vaage chhe", e:"The drum plays very loudly"},
  "તડકો": {s:"બહાર બહુ તડકો છે", r:"baahaar bahu taḍko chhe", e:"There is a lot of sunshine outside"},
  "તપેલી": {s:"તપેલીમાં દૂધ ગરમ છે", r:"tapelimaaṁ doodh garam chhe", e:"The milk in the pot is hot"},
  "તરવું": {s:"મને નદીમાં તરવું ગમે છે", r:"mane nadeemaa tarvuṁ game chhe", e:"I like to swim in the river"},
  "તળવું": {s:"મને બટાકા તળવા ગમે છે", r:"mane baṭaakaa taḷvaa game chhe", e:"I like to fry potatoes"},
  "તવો": {s:"તવો ચૂલા પર છે", r:"tavo choolaa par chhe", e:"The griddle is on the stove"},
  "તહેવાર": {s:"દિવાળી મારો પ્રિય તહેવાર છે", r:"divaaḷi maaro priya tehvaar chhe", e:"Diwali is my favorite festival"},
  "તાજું": {s:"આ શાક બહુ તાજું છે", r:"aa shaak bahu taajuṁ chhe", e:"This vegetable is very fresh"},
  "તારો": {s:"આકાશમાં એક તારો ચમકે છે", r:"aakaashmaaṁ ek taaro chamke chhe", e:"A star shines in the sky"},
  "તાળી": {s:"બાળકો તાળી પાડે છે", r:"baaḷko taaḷi paaḍe chhe", e:"The children clap their hands"},
  "તાવ": {s:"મને કાલથી તાવ છે", r:"mane kaalthi taav chhe", e:"I have had a fever since yesterday"},
  "તીર્થ": {s:"અમે તીર્થ જવાના છીએ", r:"ame teerth javaanaa chhie", e:"We are going to a pilgrimage place"},
  "તેર": {s:"મારી બહેન તેર વર્ષની છે", r:"maari bahen ter varshni chhe", e:"My sister is thirteen years old"},
  "તેલ": {s:"તેલમાં પૂરી તળો", r:"telmaaṁ poori taḷo", e:"Fry the puri in oil"},
  "ત્રણ": {s:"મારી પાસે ત્રણ પેન છે", r:"maari paase traṇ pen chhe", e:"I have three pens"},
  "ત્રીજો": {s:"એ ત્રીજા માળે રહે છે", r:"e treejaa maale rahe chhe", e:"He lives on the third floor"},
  "ત્રીસ": {s:"મહિનામાં ત્રીસ દિવસ હોય છે", r:"mahinaamaaṁ trees divas hoy chhe", e:"There are thirty days in a month"},
  "થાકેલું": {s:"બાળક આજે બહુ થાકેલું છે", r:"baaḷak aaje bahu thaakeluṁ chhe", e:"The child is very tired today"},
  "થાળી": {s:"મને ગુજરાતી થાળી ભાવે છે", r:"mane gujaraati thaaḷi bhaave chhe", e:"I like the Gujarati thali"},
  "થેપલા": {s:"બા ગરમ થેપલા બનાવે છે", r:"baa garam theplaa banaave chhe", e:"Mom makes hot theplas"},
  "થોડું": {s:"મને થોડું પાણી આપો", r:"mane thoḍuṁ paaṇi aapo", e:"Give me a little water"},
  "દડો": {s:"દડો બહુ મોટો છે", r:"daḍo bahu moṭo chhe", e:"The ball is very big"},
  "દફ્તર": {s:"મારું દફ્તર ભારે છે", r:"maaruṁ daftar bhaare chhe", e:"My schoolbag is heavy"},
  "દયાળુ": {s:"મારી મા બહુ દયાળુ છે", r:"maari maa bahu dayaaḷu chhe", e:"My mother is very kind"},
  "દરિયો": {s:"દરિયો બહુ મોટો છે", r:"dariyo bahu moṭo chhe", e:"The sea is very big"},
  "દરેક": {s:"દરેક વિદ્યાર્થી હાજર છે", r:"darek vidyaarthi haajar chhe", e:"Each student is present"},
  "દવા": {s:"તું દવા લઈ લે", r:"tu davaa lai le", e:"You take your medicine"},
  "દવાખાનું": {s:"દવાખાનું ઘરની પાસે છે", r:"davaakhaanuṁ gharni paase chhe", e:"The hospital is near the house"},
  "દસ": {s:"મારી પાસે દસ રૂપિયા છે", r:"maari paase das rupiyaa chhe", e:"I have ten rupees"},
  "દાંત": {s:"તારા દાંત સાફ કર", r:"taaraa daant saaf kar", e:"Brush your teeth"},
  "દાડમ": {s:"દાડમ લાલ હોય છે", r:"daaḍam laal hoy chhe", e:"Pomegranates are red"},
  "દાદર": {s:"તે દાદર ચઢીને ઉપર ગયો", r:"te daadar chaḍheene upar gayo", e:"He climbed the stairs and went up"},
  "દાદા": {s:"દાદા બગીચામાં બેઠા છે", r:"daadaa bageechaamaa beṭhaa chhe", e:"Grandfather is sitting in the garden"},
  "દાદી": {s:"દાદી વાર્તા કહે છે", r:"daadi vaartaa kahe chhe", e:"Grandmother tells a story"},
  "દાબેલી": {s:"એક દાબેલી આપો ને", r:"ek daabeli aapo ne", e:"Please give me one dabeli"},
  "દાળ": {s:"દાળ બહુ સ્વાદિષ્ટ છે", r:"daaḷ bahu svaadishṭ chhe", e:"The lentils are very tasty"},
  "દિવાળી": {s:"દિવાળીમાં અમે દીવા પ્રગટાવીએ છીએ", r:"divaaḷimaa ame diivaa pragṭaavie chhie", e:"On Diwali we light lamps"},
  "દીકરી": {s:"મારી દીકરી શાળાએ જાય છે", r:"maari deekri shaaḷaae jaay chhe", e:"My daughter goes to school"},
  "દીકરો": {s:"તેમનો દીકરો નાનો છે", r:"temno deekro naano chhe", e:"Their son is small"},
  "દીદી": {s:"દીદી કૉલેજ જાય છે", r:"deedi college jaay chhe", e:"Older sister goes to college"},
  "દીવાલ": {s:"દીવાલ પર ફોટો છે", r:"deevaal par foṭo chhe", e:"There is a photo on the wall"},
  "દીવો": {s:"દીવો ટેબલ પર બળે છે", r:"deevo ṭebal par baḷe chhe", e:"The lamp is burning on the table"},
  "દુકાન": {s:"આ દુકાન બહુ મોટી છે", r:"aa dukaan bahu moṭi chhe", e:"This shop is very big"},
  "દુકાનદાર": {s:"દુકાનદાર મને ફળ આપે છે", r:"dukaandaar mane phaḷ aape chhe", e:"The shopkeeper gives me fruit"},
  "દુખાવો": {s:"મારા માથામાં દુખાવો છે", r:"maaraa maathaamaa dukhaavo chhe", e:"I have a pain in my head"},
  "દુપટ્ટો": {s:"મારો દુપટ્ટો વાદળી છે", r:"maaro dupaṭṭo vaadḷi chhe", e:"My scarf is blue"},
  "દૂધ": {s:"બાળક દૂધ પીવે છે", r:"baaḷak doodh peeve chhe", e:"The child drinks milk"},
  "દૂર": {s:"સ્ટેશન અહીંથી દૂર છે", r:"sṭeshan aheethee door chhe", e:"The station is far from here"},
  "દેડકો": {s:"દેડકો પાણીમાં કૂદ્યો", r:"deḍko paaṇimaaṁ koodyo", e:"The frog jumped into the water"},
  "દોરી": {s:"દોરી બહુ મજબૂત છે", r:"dori bahu majboot chhe", e:"The rope is very strong"},
  "દ્રાક્ષ": {s:"દ્રાક્ષ મીઠી છે", r:"draaksh meeṭhi chhe", e:"The grapes are sweet"},
  "ધમાલ": {s:"પાર્ટીમાં બહુ ધમાલ થઈ", r:"paartimaaṁ bahu dhamaal thai", e:"The party was a blast"},
  "ધૂળ": {s:"ટેબલ પર ધૂળ છે", r:"ṭebal par dhooḷ chhe", e:"There is dust on the table"},
  "ધોતી": {s:"દાદા ધોતી પહેરે છે", r:"daadaa dhoti pahere chhe", e:"Grandfather wears a dhoti"},
  ...
  "નાના": {s:"નાના ગામમાં રહે છે", r:"naanaa gaammaa rahe chhe", e:"Grandfather lives in the village"},
  "નાની": {s:"નાની મીઠાઈ બનાવે છે", r:"naani miṭhaai banaave chhe", e:"Grandmother makes sweets"},
  "નાનું": {s:"આ બિલાડી નાની છે", r:"aa bilaaḍi naani chhe", e:"This cat is small"},
  "નારંગી": {s:"નારંગી ફળ મીઠું છે", r:"naarangi phaḷ meeṭhuṁ chhe", e:"The orange fruit is sweet"},
  "નિશાળ": {s:"હું નિશાળે જાઉં છું", r:"huṁ nishaaḷe jaauṁ chhuṁ", e:"I go to school"},
  "નીચે": {s:"દડો ખુરશી નીચે છે", r:"daḍo khurshi neeche chhe", e:"The ball is under the chair"},
  "નૃત્ય": {s:"તેનું નૃત્ય બહુ સુંદર છે", r:"tenuṁ nrutya bahu sundar chhe", e:"Her dance is very beautiful"},
  "નેવું": {s:"મારી પાસે નેવું રૂપિયા છે", r:"maari paase nevuṁ rupiyaa chhe", e:"I have ninety rupees"},
  "નોટ": {s:"આ પાંચસો રૂપિયાની નોટ છે", r:"aa paanchso roopiyaani noṭ chhe", e:"This is a five-hundred rupee banknote"},
  "પંદર": {s:"મેં પંદર કેરી ખરીદી", r:"meṁ pandar keri kharidi", e:"I bought fifteen mangoes"},
  "પક્ષી": {s:"પક્ષી આકાશમાં ઊડે છે", r:"pakshi aakaashmaa ooḍe chhe", e:"The bird flies in the sky"},
  "પગ": {s:"મારો પગ દુખે છે", r:"maaro pag dukhe chhe", e:"My leg hurts"},
  "પગાર": {s:"મને દર મહિને પગાર મળે છે", r:"mane dar mahine pagaar maḷe chhe", e:"I get a salary every month"},
  "પચાસ": {s:"મેં પચાસ રૂપિયા આપ્યા", r:"meṁ pachaas rupiyaa aapyaa", e:"I gave fifty rupees"},
  "પચ્ચીસ": {s:"વર્ગમાં પચ્ચીસ વિદ્યાર્થી છે", r:"vargmaaṁ pachchees vidyaarthi chhe", e:"There are twenty-five students in the class"},
  "પટોળું": {s:"મારી બા પાસે સુંદર પટોળું છે", r:"maari baa paase sundar paṭoḷuṁ chhe", e:"My mother has a beautiful Patola silk sari"},
  "પડવું": {s:"ઝાડ પરથી પાન પડ્યું", r:"jhaaḍ parathee paan paḍyuṁ", e:"A leaf fell from the tree"},
  "પતંગ": {s:"મારો પતંગ આકાશમાં ઊડે છે", r:"maaro patang aakaashmaa ooḍe chhe", e:"My kite flies in the sky"},
  "પતંગિયું": {s:"પતંગિયું ફૂલ પર બેઠું છે", r:"patangiyuṁ phool par beṭhuṁ chhe", e:"A butterfly is sitting on the flower"},
  "પથ્થર": {s:"રસ્તા પર મોટો પથ્થર છે", r:"rastaa par moṭo paththar chhe", e:"There is a big stone on the road"},
  "પપ્પા": {s:"પપ્પા ઓફિસ ગયા છે", r:"pappaa office gayaa chhe", e:"Dad has gone to the office"},
  "પરચૂરણ": {s:"મારી પાસે પરચૂરણ નથી", r:"maari paase parchooraṇ nathi", e:"I don't have any loose change"},
  "પરીક્ષા": {s:"કાલે મારી પરીક્ષા છે", r:"kaale maari pariksha chhe", e:"My exam is tomorrow"},
  "પર્વત": {s:"પર્વત બહુ ઊંચો છે", r:"parvat bahu ooncho chhe", e:"The mountain is very tall"},
  "પર્સ": {s:"મારું પર્સ ટેબલ પર છે", r:"maaruṁ pars ṭebal par chhe", e:"My purse is on the table"},
  "પલંગ": {s:"બાળક પલંગ પર સૂએ છે", r:"baaḷak palang par sooe chhe", e:"The child sleeps on the bed"},
  "પવન": {s:"બહાર ઠંડો પવન વાય છે", r:"baahaar ṭhanḍo pavan vaay chhe", e:"A cold wind is blowing outside"},
  "પહેરણ": {s:"આ પહેરણ બહુ સરસ છે", r:"aa paheraṇ bahu saras chhe", e:"This shirt is very nice"},
  "પહેલો": {s:"આ મારો પહેલો દિવસ છે", r:"aa maaro pahelo divas chhe", e:"This is my first day"},
  "પહોંચવું": {s:"અમે સમયસર શાળાએ પહોંચ્યા", r:"ame samaysar shaaḷaae pahonchyaa", e:"We arrived at school on time"},
  "પાંચ": {s:"મારા હાથમાં પાંચ આંગળી છે", r:"maaraa haathmaaṁ paanch aangaḷi chhe", e:"There are five fingers on my hand"},
  "પાંચમો": {s:"એ પાંચમા ધોરણમાં ભણે છે", r:"e paanchmaa dhoraṇmaa bhaṇe chhe", e:"He studies in the fifth grade"},
  "પાંચસો": {s:"મારી પાસે પાંચસો રૂપિયા છે", r:"maari paase paanchso rupiyaa chhe", e:"I have five hundred rupees"},
  "પાક": {s:"આ વર્ષે પાક બહુ સારો છે", r:"aa varshe paak bahu saaro chhe", e:"This year the crop is very good"},
  "પાછળ": {s:"કૂતરો ઘરની પાછળ છે", r:"kootro gharni paachhaḷ chhe", e:"The dog is behind the house"},
  "પાણી": {s:"મને પાણી પીવું છે", r:"mane paṇi peevuṁ chhe", e:"I want to drink water"},
  "પાણીપૂરી": {s:"ચાલો પાણીપૂરી ખાવા જઈએ", r:"chaalo paṇipoori khaavaa jaie", e:"Let's go eat pani puri"},
  "પાસપોર્ટ": {s:"મારો પાસપોર્ટ બેગમાં છે", r:"maaro paasporṭ begmaaṁ chhe", e:"My passport is in the bag"},
  "પાસે": {s:"મારું ઘર શાળા પાસે છે", r:"maaruṁ ghar shaaḷaa paase chhe", e:"My house is near the school"},
  "પિતરાઈ": {s:"મારો પિતરાઈ મુંબઈ રહે છે", r:"maaro pitraai mumbai rahe chhe", e:"My cousin lives in Mumbai"},
  "પિતા": {s:"મારા પિતા ડૉક્ટર છે", r:"maaraa pitaa ḍôkṭar chhe", e:"My father is a doctor"},
  "પીણું": {s:"મારે ઠંડું પીણું જોઈએ", r:"maare ṭhaṁḍuṁ peeṇuṁ joee-e", e:"I want a cold drink"},
  "પીરસવું": {s:"મા બધાને જમવાનું પીરસે છે", r:"maa badhaane jamvaanuṁ peerse chhe", e:"Mother serves food to everyone"},
  "પીળો": {s:"સૂરજ પીળો દેખાય છે", r:"sooraj peeḷo dekhaay chhe", e:"The sun looks yellow"},
  "પીવું": {s:"મને પાણી પીવું છે", r:"mane paaṇee peevuṁ chhe", e:"I want to drink water"},
  "પૂછવું": {s:"મારે એક સવાલ પૂછવો છે", r:"maare ek savaal poochhvo chhe", e:"I want to ask a question"},
  "પૂજા": {s:"મમ્મી મંદિરમાં પૂજા કરે છે", r:"mammi mandirmaa poojaa kare chhe", e:"Mom does puja in the temple"},
  "પૂરતું": {s:"મારી પાસે પૂરતું નાણું છે", r:"maari paase poortuṁ naaṇuṁ chhe", e:"I have enough money"},
  "પેચકસ": {s:"પેચકસથી સ્ક્રૂ ખોલો", r:"pechkasthi skroo kholo", e:"Open the screw with the screwdriver"},
  "પેટ": {s:"મારું પેટ ભરેલું છે", r:"maaruṁ peṭ bharelu chhe", e:"My stomach is full"},
  "પેન": {s:"મને પેન આપો", r:"mane pen aapo", e:"Give me a pen"},
  "પેન્સિલ": {s:"આ પેન્સિલ લાલ છે", r:"aa pensil laal chhe", e:"This pencil is red"},
  "પૈસા": {s:"મારી પાસે પૈસા નથી", r:"maari paase paisaa nathi", e:"I don't have money"},
  "પોતું": {s:"પોતાથી ભોંય લૂછો", r:"potaathi bhoy loochho", e:"Wipe the floor with the mopping cloth"},
  "પોલીસ": {s:"જલદી પોલીસને બોલાવો", r:"jaldi poleesne bolaavo", e:"Call the police quickly"},
  "પ્રખ્યાત": {s:"તે એક પ્રખ્યાત ગાયક છે", r:"te ek prakhyaat gaayak chhe", e:"He is a famous singer"},
  "પ્રશ્ન": {s:"મને એક પ્રશ્ન પૂછવો છે", r:"mane ek prashna poochhvo chhe", e:"I want to ask a question"},
  "પ્રસાદ": {s:"પૂજા પછી અમને પ્રસાદ મળ્યો", r:"poojaa pachhi amne prasaad maḷyo", e:"After the puja we got prasad"},
  "પ્રાર્થના": {s:"અમે રોજ સવારે પ્રાર્થના કરીએ છીએ", r:"ame roj savaare praarthanaa karie chhie", e:"We pray every morning"},
  "પ્રેમ": {s:"મને મારા દેશ પર પ્રેમ છે", r:"mane maaraa desh par prem chhe", e:"I love my country"},
  "ફરવું": {s:"અમે બગીચામાં ફરવા ગયા", r:"ame bageechaamaan pharvaa gayaa", e:"We went to wander in the garden"},
  "ફરસાણ": {s:"મને ફરસાણ બહુ ભાવે છે", r:"mane pharsaaṇ bahu bhaave chhe", e:"I really like savory snacks"},
  "ફાડુ": {s:"તારો આઈડિયા ફાડુ છે", r:"taaro aaiḍiyaa faaḍu chhe", e:"Your idea is top-tier"},
  "ફાફડા": {s:"સવારે અમે ફાફડા ખાધા", r:"savaare ame phaaphḍaa khaadhaa", e:"In the morning we ate fafda"},
  "ફોઈ": {s:"ફોઈ અમારા ઘરે આવ્યાં", r:"foi amaaraa ghare aavyaaṁ", e:"Aunt came to our home"},
  "ફોટો": {s:"આ ફોટો બહુ સરસ છે", r:"aa phoṭo bahu saras chhe", e:"This photo is very nice"},
  "ફોન": {s:"મારો ફોન ટેબલ પર છે", r:"maaro phon ṭebal par chhe", e:"My phone is on the table"},
  "બંગડી": {s:"તેની બંગડી બહુ સુંદર છે", r:"teni bangḍi bahu sundar chhe", e:"Her bangle is very beautiful"},
  "બકરી": {s:"બકરી નાની અને સફેદ છે", r:"bakri naani ane safed chhe", e:"The goat is small and white"},
  "બકા": {s:"બકા, ચિંતા ના કર", r:"baka, chintaa naa kar", e:"Buddy, don't worry"},
  "બચત": {s:"બચત કરવી બહુ સારી છે", r:"bachat karvi bahu saari chhe", e:"Saving money is very good"},
  "બચાવો": {s:"બચાવો, કોઈ મદદ કરો!", r:"bachaavo, koi madad karo!", e:"Save me, somebody help!"},
  "બજાર": {s:"મમ્મી બજારમાં શાક લે છે", r:"mammi bajaarmaaṁ shaak le chhe", e:"Mom is buying vegetables in the market"},
  "બટાકા": {s:"મને બટાકા ભાવે છે", r:"mane baṭaakaa bhaave chhe", e:"I like potatoes"},
  "બધું": {s:"મને બધું સમજાય છે", r:"mane badhuṁ samjaay chhe", e:"I understand everything"},
  "બપોર": {s:"બપોરે અમે જમીએ છીએ", r:"bapore ame jamie chhie", e:"In the afternoon we eat lunch"},
  "બસ": {s:"બસ મોડી આવી", r:"bas moḍi aavi", e:"The bus came late"},
  "બસો": {s:"આ શર્ટ બસો રૂપિયાનું છે", r:"aa sharṭ baso rupiyaanuṁ chhe", e:"This shirt costs two hundred rupees"},
  "બહાદુર": {s:"તે એક બહાદુર સૈનિક છે", r:"te ek bahaadur sainik chhe", e:"He is a brave soldier"},
  "બહાર": {s:"બાળકો બહાર રમે છે", r:"baaḷko bahaar rame chhe", e:"The children are playing outside"},
  "બા": {s:"બા મંદિર જાય છે", r:"baa mandir jaay chhe", e:"Grandma goes to the temple"},
  "બાંધણી": {s:"મને બાંધણી સાડી બહુ ગમે છે", r:"mane baandhaṇi saaḍi bahu game chhe", e:"I really like tie-dye sarees"},
  "બાજુ": {s:"મારી બાજુ બેસો", r:"maari baaju beso", e:"Sit beside me"},
  "બાફવું": {s:"પહેલા દૂધ બાફો", r:"pahelaa doodh baafo", e:"First boil the milk"},
  "બાર": {s:"વર્ષમાં બાર મહિના હોય છે", r:"varshmaaṁ baar mahinaa hoy chhe", e:"There are twelve months in a year"},
  "બારણું": {s:"બારણું બંધ કરો", r:"baarṇuṁ bandh karo", e:"Close the door"},
  "બારી": {s:"બારી ખુલ્લી છે", r:"baari khulli chhe", e:"The window is open"},
  "બાળક": {s:"બાળક બગીચામાં રમે છે", r:"baaḷak bageechaamaa rame chhe", e:"The child is playing in the garden"},
  "બિંદાસ": {s:"એ છોકરો બિંદાસ છે", r:"e chhokro bindaas chhe", e:"That boy is carefree"},
  "બિયારણ": {s:"ખેડૂત ખેતરમાં બિયારણ વાવે છે", r:"kheḍoot khetarmaa biyaaraṇ vaave chhe", e:"The farmer sows seed in the field"},
  "બિલ": {s:"બિલ લઈ આવો", r:"bil laee aavo", e:"Please bring the bill"},
  "બિલાડી": {s:"બિલાડી દૂધ પીવે છે", r:"bilaaḍi doodh peeve chhe", e:"The cat is drinking milk"},
  "બીજો": {s:"આ મારો બીજો પ્રયાસ છે", r:"aa maaro beejo prayaas chhe", e:"This is my second attempt"},
  "બીમાર": {s:"મારો ભાઈ આજે બીમાર છે", r:"maaro bhaai aaje beemaar chhe", e:"My brother is sick today"},
  "બુધવાર": {s:"બુધવારે અમે બજારે જઈએ છીએ", r:"budhvaare ame bajaare jaie chhie", e:"On Wednesday we go to the market"},
  "બે": {s:"મારી પાસે બે પુસ્તક છે", r:"maari paase be pustak chhe", e:"I have two books"},
  "બેંક": {s:"હું બેંકમાં જાઉં છું", r:"huṁ benkmaa jaauṁ chhuṁ", e:"I am going to the bank"},
  "બેટરી": {s:"ફોનની બેટરી ઓછી છે", r:"phonni beṭri ochhi chhe", e:"The phone's battery is low"},
  "બોલવું": {s:"ધીમેથી બોલવું સારું છે", r:"dheemethee bolvuṁ saaruṁ chhe", e:"Speaking slowly is good"},
  "ભક્તિ": {s:"દાદીની ભગવાનમાં બહુ ભક્તિ છે", r:"daadini bhagavaanmaa bahu bhakti chhe", e:"Grandma has great devotion to God"},
  "ભજિયા": {s:"મને ગરમ ભજિયા બહુ ભાવે છે", r:"mane garam bhajiyaa bahu bhaave chhe", e:"I really like hot fritters"},
  "ભત્રીજી": {s:"મારી ભત્રીજી ગીત ગાય છે", r:"maari bhatreeji geet gaay chhe", e:"My niece sings a song"},
  "ભત્રીજો": {s:"મારો ભત્રીજો બહુ હોશિયાર છે", r:"maaro bhatreejo bahu hoshiyaar chhe", e:"My nephew is very clever"},
  "ભાઈ": {s:"ભાઈ, શું ચાલે છે?", r:"bhaai, shuṁ chaale chhe?", e:"Bro, what's up?"},
  "ભાઈબહેન": {s:"અમે ત્રણ ભાઈબહેન છીએ", r:"ame traṇ bhaaibahen chhie", e:"We are three siblings"},
  "ભાણેજ": {s:"મારું ભાણેજ નાનું છે", r:"maaruṁ bhaaṇej naanuṁ chhe", e:"My sister's child is small"},
  "ભાત": {s:"મને ભાત ખાવો ગમે છે", r:"mane bhaat khaavo game chhe", e:"I like to eat rice"},
  "ભાવ": {s:"શાકનો ભાવ શું છે?", r:"shaakno bhaav shuṁ chhe?", e:"What is the price of the vegetables?"},
  "ભીંડો": {s:"ભીંડો લીલો હોય છે", r:"bheenḍo leelo hoy chhe", e:"Okra is green"},
  "ભૂખ": {s:"મને બહુ ભૂખ લાગી છે", r:"mane bahu bhookh laagi chhe", e:"I am very hungry"},
  "ભેળ": {s:"આ ભેળ બહુ સ્વાદિષ્ટ છે", r:"aa bhel bahu svaadishṭ chhe", e:"This bhel is very tasty"},
  "ભોંયતળિયું": {s:"દુકાન ભોંયતળિયે છે", r:"dukaan bhonytaḷiye chhe", e:"The shop is on the ground floor"},
  "મંગળવાર": {s:"મંગળવારે મારી પરીક્ષા છે", r:"mangaḷvaare maari pariksha chhe", e:"My exam is on Tuesday"},
  "મંડપ": {s:"મંડપ ફૂલોથી સજાવ્યો છે", r:"manḍap phoolothi sajaavyo chhe", e:"The wedding canopy is decorated with flowers"},
  "મંદિર": {s:"અમે મંદિરમાં જઈએ છીએ", r:"ame mandirmaaṁ jaie chhie", e:"We are going to the temple"},
  "મકાન": {s:"આ મકાન બહુ મોટું છે", r:"aa makaan bahu moṭuṁ chhe", e:"This building is very big"},
  "મચ્છર": {s:"મચ્છર મને કરડ્યો", r:"machchhar mane karaḍyo", e:"A mosquito bit me"},
  "મજબૂત": {s:"મારા પપ્પા બહુ મજબૂત છે", r:"maaraa pappaa bahu majboot chhe", e:"My father is very strong"},
  "મદદ": {s:"મને તમારી મદદ જોઈએ છે", r:"mane tamaari madad joie chhe", e:"I need your help"},
  "મધમાખી": {s:"મધમાખી મધ બનાવે છે", r:"madhmaakhi madh banaave chhe", e:"The bee makes honey"},
  "મમ્મી": {s:"મમ્મી રસોઈ બનાવે છે", r:"mammi rasoi banaave chhe", e:"Mom is cooking"},
  "મળવું": {s:"આપણે કાલે મળીશું", r:"aapṇe kaale maḷeeshuṁ", e:"We will meet tomorrow"},
  "મસાલો": {s:"શાકમાં મસાલો નાખો", r:"shaakmaaṁ masaalo naakho", e:"Put spice mix in the vegetables"},
  "મસ્ત": {s:"આ ફિલ્મ મસ્ત છે", r:"aa film mast chhe", e:"This movie is awesome"},
  "મહેનતુ": {s:"મારો ભાઈ બહુ મહેનતુ છે", r:"maaro bhaai bahu mahenatu chhe", e:"My brother is very hardworking"},
  "મહેમાન": {s:"ઘરે ઘણા મહેમાન આવ્યા છે", r:"ghare ghaṇaa mahemaan aavyaa chhe", e:"Many guests have come home"},
  "માંસાહારી": {s:"તે માંસાહારી ખોરાક ખાય છે", r:"te maansaahaari khoraak khaay chhe", e:"He eats non-vegetarian food"},
  "માખી": {s:"માખી ખોરાક પર બેઠી છે", r:"maakhi khoraak par beṭhi chhe", e:"A fly is sitting on the food"},
  "માછલી": {s:"માછલી પાણીમાં તરે છે", r:"maachhli paaṇimaa tare chhe", e:"The fish swims in the water"},
  "માટી": {s:"માટી બહુ ભીની છે", r:"maaṭi bahu bhini chhe", e:"The soil is very wet"},
  "માતા": {s:"મારી માતા ખૂબ દયાળુ છે", r:"maari maataa khoob dayaaḷu chhe", e:"My mother is very kind"},
  "માતાપિતા": {s:"મારા માતાપિતા ગામ ગયા છે", r:"maaraa maataapitaa gaam gayaa chhe", e:"My parents have gone to the village"},
  "માથું": {s:"મારું માથું દુખે છે", r:"maaruṁ maathuṁ dukhe chhe", e:"My head hurts"},
  "મામા": {s:"મામા મને ભેટ લાવ્યા", r:"maamaa mane bheṭ laavyaa", e:"Uncle brought me a gift"},
  "માળ": {s:"અમે બીજા માળ પર રહીએ છીએ", r:"ame beejaa maaḷ par rahie chhie", e:"We live on the second floor"},
  "માસી": {s:"માસી બહુ પ્રેમાળ છે", r:"maasi bahu premaaḷ chhe", e:"Aunt is very loving"},
  "મીટિંગ": {s:"આજે સવારે મીટિંગ છે", r:"aaje savaare meeṭing chhe", e:"There is a meeting this morning"},
  "મીઠું": {s:"શાકમાં મીઠું ઓછું છે", r:"shaakmaaṁ meeṭhuṁ ochhuṁ chhe", e:"There is little salt in the curry"},
  "મુસાફર": {s:"મુસાફર વિમાનની રાહ જુએ છે", r:"musaafar vimaannee raah jue chhe", e:"The passenger waits for the plane"},
  "મુસાફરી": {s:"અમારી મુસાફરી બહુ સરસ હતી", r:"amaaree musaafari bahu saras hatee", e:"Our journey was very nice"},
  "મેજ": {s:"પુસ્તક મેજ પર છે", r:"pustak mej par chhe", e:"The book is on the table"},
  "મેનુ": {s:"મને મેનુ આપો", r:"mane menu aapo", e:"Please give me the menu"},
  "મેળો": {s:"અમે ગામના મેળામાં ગયા", r:"ame gaamnaa melaamaa gayaa", e:"We went to the village fair"},
  "મોંઘું": {s:"આ કપડું બહુ મોંઘું છે", r:"aa kapḍuṁ bahu monghuṁ chhe", e:"This cloth is very expensive"},
  "મોટું": {s:"મારું ઘર બહુ મોટું છે", r:"maaruṁ ghar bahu moṭuṁ chhe", e:"My house is very big"},
  "મોઢું": {s:"તારું મોઢું ધોઈ લે", r:"taaruṁ moḍhuṁ dhoi le", e:"Wash your face"},
  "મોબાઇલ": {s:"મારી પાસે નવો મોબાઇલ છે", r:"maari paase navo mobaail chhe", e:"I have a new mobile phone"},
  "રખડવું": {s:"તે આખો દિવસ રખડે છે", r:"te aakho divas rakhaḍe chhe", e:"He roams around all day"},
  "રજા": {s:"આજે મારે રજા છે", r:"aaje maare rajaa chhe", e:"Today I have a day off"},
  "રમત": {s:"મને આ રમત બહુ ગમે છે", r:"mane aa ramat bahu game chhe", e:"I really like this game"},
  "રમવું": {s:"બાળકોને બગીચામાં રમવું ગમે છે", r:"baaḷkone bageechaamaa ramvuṁ game chhe", e:"Children like to play in the garden"},
  "રમૂજી": {s:"મારો મિત્ર બહુ રમૂજી છે", r:"maaro mitra bahu ramooji chhe", e:"My friend is very funny"},
  "રવિવાર": {s:"રવિવારે અમે આરામ કરીએ છીએ", r:"ravivaare ame aaraam karie chhie", e:"On Sunday we rest"},
  "રસોઇયો": {s:"રસોઇયો સ્વાદિષ્ટ ભોજન બનાવે છે", r:"rasoiyo svaadishṭ bhojan banaave chhe", e:"The cook makes delicious food"},
  "રસોઈ": {s:"મમ્મી રસોઈ કરે છે", r:"mammi rasoi kare chhe", e:"Mom is cooking"},
  "રસોડું": {s:"મમ્મી રસોડામાં કામ કરે છે", r:"mammi rasoḍaamaaṁ kaam kare chhe", e:"Mom is working in the kitchen"},
  "રસ્તો": {s:"આ રસ્તો બજાર તરફ જાય છે", r:"aa rasto bajaar taraf jaay chhe", e:"This road goes toward the market"},
  "રહેવું": {s:"હું અમદાવાદમાં રહું છું", r:"huṁ amdaavaadmaaṁ rahuṁ chhuṁ", e:"I live in Ahmedabad"},
  "રાંધવું": {s:"મારી મા રોજ રસોઈ રાંધે છે", r:"maari maa roj rasoi raandhe chhe", e:"My mother cooks food every day"},
  "રાત": {s:"રાતે આકાશમાં તારા દેખાય છે", r:"raate aakaashmaaṁ taaraa dekhaay chhe", e:"At night stars appear in the sky"},
  "રાસ": {s:"નવરાત્રિમાં અમે રાસ રમીએ છીએ", r:"navraatrimaaṁ ame raas ramie chhie", e:"During Navratri we play raas"},
  "રિક્ષા": {s:"અમે રિક્ષામાં બજાર ગયા", r:"ame riksaamaa bajaar gayaa", e:"We went to the market in an auto-rickshaw"},
  "રીંગણ": {s:"મમ્મી રીંગણનું શાક બનાવે છે", r:"mammi reengaṇnuṁ shaak banaave chhe", e:"Mom is making eggplant curry"},
  "રૂપિયા": {s:"મારી પાસે સો રૂપિયા છે", r:"maari paase so roopiyaa chhe", e:"I have a hundred rupees"},
  "રોટલી": {s:"મમ્મી ગરમ રોટલી બનાવે છે", r:"mammi garam roṭli banaave chhe", e:"Mom makes hot roti"},
  "લખવું": {s:"મને પત્ર લખવો ગમે છે", r:"mane patra lakhvo game chhe", e:"I like to write a letter"},
  "લગ્ન": {s:"કાલે મારી બહેનનાં લગ્ન છે", r:"kaale maari bahennaaṁ lagna chhe", e:"My sister's wedding is tomorrow"},
  "લણણી": {s:"અમે લણણી કરવા ખેતરે જઈએ છીએ", r:"ame laṇṇi karvaa khetare jaie chhie", e:"We go to the field to do the harvest"},
  "લપસવું": {s:"હું બરફ પર લપસી ગયો", r:"huṁ baraph par lapasee gayo", e:"I slipped on the ice"},
  "લફડો": {s:"મારે કોઈ લફડો નથી જોઈતો", r:"maare koi lafḍo nathi joito", e:"I don't want any trouble"},
  "લસણ": {s:"મને લસણ બહુ ગમે છે", r:"mane lasaṇ bahu game chhe", e:"I really like garlic"},
  "લાકડું": {s:"આ ટેબલ લાકડાનું બનેલું છે", r:"aa ṭebal laakḍaanuṁ baneluṁ chhe", e:"This table is made of wood"},
  "લાખ": {s:"આ ગાડી એક લાખની છે", r:"aa gaaḍi ek laakhni chhe", e:"This car costs one lakh"},
  "લાલ": {s:"મારી પાસે લાલ ગુલાબ છે", r:"maari paase laal gulaab chhe", e:"I have a red rose"},
  "લિફ્ટ": {s:"લિફ્ટ આજે બંધ છે", r:"lifṭ aaje bandh chhe", e:"The lift is closed today"},
  "લીલો": {s:"ઘાસ લીલું હોય છે", r:"ghaas leeluṁ hoy chhe", e:"Grass is green"},
  "લૂછવું": {s:"કપડાથી બારી લૂછવું", r:"kapḍaathi baari loochhvuṁ", e:"To wipe the window with a cloth"},
  "લેવું": {s:"તમે શું લેશો?", r:"tame shuṁ lesho?", e:"What will you take?"},
  "લોખંડ": {s:"આ દરવાજો લોખંડનો છે", r:"aa darvaajo lokhanḍno chhe", e:"This door is made of iron"},
  "લોચો": {s:"આજે તો મોટો લોચો થઈ ગયો", r:"aaje to moṭo locho thai gayo", e:"Today a big mix-up happened"},
  "લોટ": {s:"લોટ બાંધીને રોટલી બનાવો", r:"loṭ baaṁdhine roṭli banaavo", e:"Knead the dough and make rotli"},
  "વચ્ચે": {s:"દુકાન બે ઘરની વચ્ચે છે", r:"dukaan be gharni vachche chhe", e:"The shop is between two houses"},
  "વડીલ": {s:"વડીલોનું સન્માન કરો", r:"vaḍiloonuṁ sanmaan karo", e:"Respect the elders"},
  "વરરાજા": {s:"વરરાજા ઘોડા પર બેઠા છે", r:"varraajaa ghoḍaa par beṭhaa chhe", e:"The groom is seated on the horse"},
  "વરસાદ": {s:"આજે વરસાદ પડે છે", r:"aaje varsaad paḍe chhe", e:"It is raining today"},
  "વાંચવું": {s:"મને પુસ્તક વાંચવું ગમે છે", r:"mane pustak vaanchvuṁ game chhe", e:"I like to read a book"},
  "વાંદરો": {s:"વાંદરો ઝાડ પર ચઢે છે", r:"vaandro jhaaḍ par chaḍhe chhe", e:"The monkey climbs the tree"},
  "વાંસળી": {s:"કૃષ્ણ વાંસળી વગાડે છે", r:"krushṇa vaansḷi vagaaḍe chhe", e:"Krishna plays the flute"},
  "વાઘ": {s:"વાઘ જંગલમાં રહે છે", r:"vaagh jangalmaa rahe chhe", e:"The tiger lives in the forest"},
  "વાદળ": {s:"આકાશમાં કાળું વાદળ છે", r:"aakaashmaaṁ kaaḷuṁ vaadaḷ chhe", e:"There is a black cloud in the sky"},
  "વાદળી": {s:"આકાશ વાદળી છે", r:"aakaash vaadaḷi chhe", e:"The sky is blue"},
  "વાળ": {s:"તેના વાળ કાળા છે", r:"tenaa vaaḷ kaaḷaa chhe", e:"Her hair is black"},
  "વાસણ": {s:"વાસણ બહુ ગંદાં છે", r:"vaasaṇ bahu gandaaṁ chhe", e:"The utensils are very dirty"},
  "વિદાય": {s:"કન્યાની વિદાય વખતે બધા રડ્યા", r:"kanyaani vidaay vakhate badhaa raḍyaa", e:"Everyone cried at the bride's send-off"},
  "વિદેશ": {s:"મારે વિદેશ જવું છે", r:"maare videsh javuṁ chhe", e:"I want to go abroad"},
  "વિદ્યાર્થી": {s:"હું એક વિદ્યાર્થી છું", r:"huṁ ek vidyaarthi chhuṁ", e:"I am a student"},
  "વિધિ": {s:"લગ્નની વિધિ શરૂ થઈ ગઈ", r:"lagnani vidhi sharu thai gai", e:"The wedding ceremony has begun"},
  "વિમાન": {s:"વિમાન આકાશમાં ઊડે છે", r:"vimaan aakaashmaa uḍe chhe", e:"The airplane flies in the sky"},
  "વિમાનમથક": {s:"વિમાનમથક શહેરથી દૂર છે", r:"vimaanmathak shaherthee door chhe", e:"The airport is far from the city"},
  "વીંટી": {s:"મારી આંગળીમાં વીંટી છે", r:"maari aangḷimaa veenṭi chhe", e:"There is a ring on my finger"},
  "વીજળી": {s:"આજે વીજળી નથી", r:"aaje veejaḷi nathi", e:"There is no electricity today"},
  "વીસ": {s:"મારી પાસે વીસ રૂપિયા છે", r:"maari paase vees rupiyaa chhe", e:"I have twenty rupees"},
  "વેઇટર": {s:"વેઇટર પાણી લાવ્યો", r:"veiṭar paaṇi laavyo", e:"The waiter brought water"},
  "વેચવું": {s:"તે શાકભાજી વેચે છે", r:"te shaakbhaaji veche chhe", e:"He sells vegetables"},
  "વેપારી": {s:"વેપારી કપડાં વેચે છે", r:"vepaari kapḍaaṁ veche chhe", e:"The merchant sells clothes"},
  "શનિવાર": {s:"શનિવારે હું રમું છું", r:"shanivaare huṁ ramuṁ chhuṁ", e:"I play on Saturday"},
  "શરદી": {s:"મને શરદી થઈ ગઈ છે", r:"mane shardi thai gai chhe", e:"I have caught a cold"},
  "શરમાળ": {s:"તે છોકરી બહુ શરમાળ છે", r:"te chhokri bahu sharmaaḷ chhe", e:"That girl is very shy"},
  "શહેર": {s:"અમદાવાદ મોટું શહેર છે", r:"amdaavaad moṭuṁ shaher chhe", e:"Ahmedabad is a big city"},
  "શાંત": {s:"તે હંમેશા શાંત રહે છે", r:"te hammeshaa shaant rahe chhe", e:"He always stays calm"},
  "શાક": {s:"આજે શાક તાજું છે", r:"aaje shaak taajuṁ chhe", e:"Today the vegetable curry is fresh"},
  "શાકાહારી": {s:"મારો ભાઈ શાકાહારી છે", r:"maaro bhaai shaakaahaari chhe", e:"My brother is vegetarian"},
  "શિક્ષક": {s:"મારા શિક્ષક બહુ સારા છે", r:"maaraa shikshak bahu saaraa chhe", e:"My teacher is very good"},
  "શિયાળો": {s:"મને શિયાળો બહુ ગમે છે", r:"mane shiyaaḷo bahu game chhe", e:"I really like winter"},
  "શીખવું": {s:"મને ગુજરાતી શીખવું ગમે છે", r:"mane gujaraati shikhvuṁ game chhe", e:"I like to learn Gujarati"},
  "શુક્રવાર": {s:"શુક્રવારે અમને રજા હોય છે", r:"shukravaare amne rajaa hoy chhe", e:"We have a holiday on Friday"},
  "શેકવું": {s:"અમે રોટલી શેકીએ છીએ", r:"ame roṭli shekie chhie", e:"We roast the rotli"},
  "સંગીત": {s:"મને સંગીત સાંભળવું ગમે છે", r:"mane sangeet saambhaḷvuṁ game chhe", e:"I like listening to music"},
  "સંતાન": {s:"તેમને એક સંતાન છે", r:"temne ek santaan chhe", e:"They have one child"},
  "સંદેશો": {s:"મેં તને સંદેશો મોકલ્યો", r:"meṁ tane sandesho mokalyo", e:"I sent you a message"},
  "સંભાળો": {s:"રસ્તો ઓળંગતી વખતે સંભાળો", r:"rasto oḷangti vakhate sambhaaḷo", e:"Be careful while crossing the road"},
  "સત્તર": {s:"મારી પાસે સત્તર પુસ્તક છે", r:"maari paase sattar pustak chhe", e:"I have seventeen books"},
  "સફરજન": {s:"આ સફરજન લાલ છે", r:"aa safarjan laal chhe", e:"This apple is red"},
  "સફેદ": {s:"મારું શર્ટ સફેદ છે", r:"maaruṁ shart safed chhe", e:"My shirt is white"},
  "સમજવું": {s:"મને આ પાઠ સમજવો છે", r:"mane aa paaṭh samajvo chhe", e:"I want to understand this lesson"},
  "સમય": {s:"અત્યારે સૂવાનો સમય છે", r:"atyaare soovaano samay chhe", e:"It is time to sleep now"},
  "સમારવું": {s:"તું શાક સમાર", r:"tuṁ shaak samaar", e:"You chop the vegetables"},
  "સવાર": {s:"સવારે હું ચા પીઉં છું", r:"savaare huṁ chaa piuṁ chhuṁ", e:"In the morning I drink tea"},
  "સસ્તું": {s:"આ ફળ બહુ સસ્તું છે", r:"aa faḷ bahu sastuṁ chhe", e:"This fruit is very cheap"},
  "સહી": {s:"અહીં તમારી સહી કરો", r:"ahiṁ tamaari sahi karo", e:"Please sign your signature here"},
  "સાંભળવું": {s:"મને ગીત સાંભળવું ગમે છે", r:"mane geet saambhaḷvuṁ game chhe", e:"I like to listen to a song"},
  "સાઇકલ": {s:"મને સાઇકલ ચલાવવી ગમે છે", r:"mane saaikal chalaavvi game chhe", e:"I like to ride a bicycle"},
  "સાઠ": {s:"મારા દાદા સાઠ વર્ષના છે", r:"maaraa daadaa saaṭh varshnaa chhe", e:"My grandfather is sixty years old"},
  "સાડી": {s:"મારી મમ્મી સાડી પહેરે છે", r:"maari mammi saaḍi pahere chhe", e:"My mother wears a saree"},
  "સાત": {s:"એક અઠવાડિયામાં સાત દિવસ છે", r:"ek aṭhvaaḍiyaamaaṁ saat divas chhe", e:"There are seven days in a week"},
  "સાપ": {s:"સાપ જમીન પર સરકે છે", r:"saap jameen par sarke chhe", e:"The snake slithers on the ground"},
  "સાબુ": {s:"સાબુથી હાથ ધુઓ", r:"saabuthi haath dhuo", e:"Wash your hands with soap"},
  "સામાન": {s:"મારો સામાન બહુ ભારે છે", r:"maaro saamaan bahu bhaare chhe", e:"My luggage is very heavy"},
  "સામે": {s:"શાળા મારા ઘરની સામે છે", r:"shaaḷaa maaraa gharni saame chhe", e:"The school is opposite my house"},
  "સારું": {s:"આ પુસ્તક બહુ સારું છે", r:"aa pustak bahu saaruṁ chhe", e:"This book is very good"},
  "સિંચાઈ": {s:"પાકને સિંચાઈની જરૂર છે", r:"paakne sinchaaini jaroor chhe", e:"The crop needs irrigation"},
  "સિક્કો": {s:"મને એક સિક્કો મળ્યો", r:"mane ek sikko maḷyo", e:"I found a coin"},
  "સિત્તેર": {s:"આ પુસ્તકમાં સિત્તેર પાનાં છે", r:"aa pustakmaaṁ sitter paanaaṁ chhe", e:"This book has seventy pages"},
  "સીટ": {s:"મારી સીટ બારી પાસે છે", r:"maari seeṭ baaree paase chhe", e:"My seat is by the window"},
  "સીધું": {s:"સીધું ચાલતા રહો", r:"seedhuṁ chaaltaa raho", e:"Keep walking straight"},
  "સુંદર": {s:"આ ફૂલ બહુ સુંદર છે", r:"aa phool bahu sundar chhe", e:"This flower is very beautiful"},
  "સૂર": {s:"તેનો સૂર બહુ મીઠો છે", r:"teno soor bahu miṭho chhe", e:"His tune is very sweet"},
  "સૂરજ": {s:"સૂરજ સવારે ઊગે છે", r:"sooraj savaare ooge chhe", e:"The sun rises in the morning"},
  "સૂવું": {s:"બાળક રાત્રે વહેલું સૂવે છે", r:"baaḷak raatre vaheluṁ soove chhe", e:"The child sleeps early at night"},
  "સો": {s:"મારી પાસે સો રૂપિયા છે", r:"maari paase so rupiyaa chhe", e:"I have a hundred rupees"},
  "સોનું": {s:"મારી પાસે સોનાની વીંટી છે", r:"maari paase sonaani viṁṭi chhe", e:"I have a gold ring"},
  "સોમવાર": {s:"સોમવારે નિશાળ ખૂલે છે", r:"somvaare nishaaḷ khule chhe", e:"School opens on Monday"},
  "સોય": {s:"સોયમાં દોરો પરોવો", r:"soymaa doro parovo", e:"Thread the string through the needle"},
  "સોળ": {s:"તે સોળ વર્ષનો છે", r:"te soḷ varshno chhe", e:"He is sixteen years old"},
  "સ્ટેશન": {s:"ટ્રેન સ્ટેશન પર ઊભી છે", r:"ṭren sṭeshan par ūbhi chhe", e:"The train is standing at the station"},
  "હજાર": {s:"આ ફોન હજાર રૂપિયાનો છે", r:"aa fon hajaar rupiyaano chhe", e:"This phone costs a thousand rupees"},
  "હથોડી": {s:"મારી પાસે નવી હથોડી છે", r:"maari paase navi hathoḍi chhe", e:"I have a new hammer"},
  "હલાવવું": {s:"દાળ ધીમે ધીમે હલાવો", r:"daaḷ dheeme dheeme halaavo", e:"Stir the dal slowly"},
  "હાથ": {s:"તારા હાથ ધો", r:"taaraa haath dho", e:"Wash your hands"},
  "હાથી": {s:"હાથી બહુ મોટો પ્રાણી છે", r:"haathi bahu moṭo praaṇi chhe", e:"The elephant is a very big animal"},
  "હાર": {s:"મારી પાસે સોનાનો હાર છે", r:"maari paase sonaano haar chhe", e:"I have a gold necklace"},
  "હારવું": {s:"કોઈ હારવા માંગતું નથી", r:"koi haarvaa maangtuṁ nathi", e:"No one wants to lose"},
  "હેડો": {s:"હેડો, ફિલ્મ જોવા જઈએ", r:"heḍo, film jovaa jaiye", e:"Let's go, let's watch a movie"},
  "હોશિયાર": {s:"મારી બહેન બહુ હોશિયાર છે", r:"maari bahen bahu hoshiyaar chhe", e:"My sister is very clever"},
};
...
ERAS.push(
  { id:"garba", category:"modern", yr:"living tradition", title:"Garba and the folk arts",
    blurb:"Gujarat's most famous cultural export: the circular dance of Navratri, plus a wider world of folk music and theatre.",
    body:[
      "Garba is the best-known cultural tradition of Gujarat: a circular dance performed during Navratri, the autumn festival of nine nights. Dancers move in rings around a central point, often an earthen pot with a lamp inside, called a garbo, or an image of a mother deity, clapping and turning in step as the tempo rises through the night.",
      "Garba is usually distinguished from raas, or dandiya raas, in which dancers strike small wooden sticks together in pairs as they move; raas is linked in tradition to Krishna and the cowherds of legend. Over the nine nights, whole neighborhoods and towns gather, and the dances range from small family circles to enormous organized events with thousands of participants.",
      "The music has grown alongside the dance. Traditional Garba is sung to the dhol and other percussion with a lead singer, and the songs praise the deity and carry devotional and folk stories. In recent decades a modern, amplified Garba scene has emerged, blending folk melody with pop and film music and drawing large ticketed crowds across Gujarat and its diaspora.",
